...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/relation": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateRelationshipRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "Relationship deletion request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "model.CreateRelationshipRequest": {
            "type": "object",
            "required": [
                "principal_id",
                "resource_name",
