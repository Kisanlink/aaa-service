...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/actions/service/{serviceName}": {
            "get": {
        ...
        "/api/v1/admin/maintenance/message": {
            "patch": {
        ...
        "/api/v1/auth/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Login credentials with optional flags for additional data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/auth/refresh": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Refresh token and MPIN",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "401": {
                        "description": "Invalid refresh token or MPIN",
                        "schema": {
                            "$ref": "#/definitions/responses.ErrorResponseSwagger"
                        }
                    },
        ...
        "/api/v1/auth/register": {
            "post": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "User already exists or conflict error",
                        "schema": {
                            "$ref": "#/definitions/responses.ErrorResponseSwagger"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kyc.GenerateOTPRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kyc.GenerateOTPResponse"
                        }
                    },
                    "400": {
        ...
        "/api/v1/kyc/aadhaar/otp/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Verify OTP request with reference ID and OTP",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kyc.VerifyOTPRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kyc.VerifyOTPResponse"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kyc.KYCStatusResponse"
                        }
                    },
                    "400": {
                    ...
                    "403": {
                        "description": "Forbidden - can only view own status",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/modules/{service_name}/health": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/roles/{id}/resources/{resId}": {
            "delete": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/principals.CreateServiceRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/services/generate-api-key": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/users/{id}/roles/{roleId}/legacy": {
            "delete": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.SeedRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Successfully seeded roles and permissions",
                        "schema": {
                            "$ref": "#/definitions/routes.SeedResponse"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/routes.SeedStatusResponse"
                        }
                    },
                    "401": {
                        "description": "Authentication required",
    ...
    "definitions": {
        ...
        "kyc.AadhaarData": {
            ...
            "properties": {
                "address": {
                    "$ref": "#/definitions/kyc.AadhaarAddr"
                },
                "care_of": {
                    "type": "string"
                },
        ...
        "kyc.VerifyOTPResponse": {
            "type": "object",
            "properties": {
                "aadhaar_data": {
                    "$ref": "#/definitions/kyc.AadhaarData"
                },
                "address_id": {
                    "type": "string"
                },
        ...
        "principals.CreateServiceRequest": {
        ...
        "routes.SeedResponse": {
            ...
            "properties": {
                ...
                "message": {
                    "type": "string",
                    "example": "Successfully seeded roles and permissions"
                },
                "permissions_created": {
                    "type": "integer",
                    "example": 72
