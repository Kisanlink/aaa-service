...
// List retrieves active (non-deleted) users with pagination
// Note: Roles are NOT preloaded for performance. Use GetUserByID for full role details.
...
// ListAll retrieves all active (non-deleted) users
// Note: Roles are NOT preloaded for performance. Use GetUserByID for full role details.
