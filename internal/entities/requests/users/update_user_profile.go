...
// NewUpdateUserProfileRequest creates a new UpdateUserProfileRequest instance
...
// Validate validates the UpdateUserProfileRequest
...
func (r *UpdateUserProfileRequest) GetUserID() string {
	return r.UserID
}

// GetName returns the name
func (r *UpdateUserProfileRequest) GetName() *string {
	return r.Name
}

// GetCareOf returns the care of
func (r *UpdateUserProfileRequest) GetCareOf() *string {
	return r.CareOf
}

// GetDateOfBirth returns the date of birth
func (r *UpdateUserProfileRequest) GetDateOfBirth() *string {
	return r.DateOfBirth
}

// GetPhoto returns the photo
func (r *UpdateUserProfileRequest) GetPhoto() *string {
	return r.Photo
}

// GetYearOfBirth returns the year of birth
func (r *UpdateUserProfileRequest) GetYearOfBirth() *string {
	return r.YearOfBirth
}

// GetMessage returns the message
func (r *UpdateUserProfileRequest) GetMessage() *string {
	return r.Message
}

// GetAadhaarNumber returns the Aadhaar number
func (r *UpdateUserProfileRequest) GetAadhaarNumber() *string {
	return r.AadhaarNumber
}

// GetEmailHash returns the email hash
func (r *UpdateUserProfileRequest) GetEmailHash() *string {
	return r.EmailHash
}

// GetShareCode returns the share code
func (r *UpdateUserProfileRequest) GetShareCode() *string {
	return r.ShareCode
}

// GetAddressID returns the address ID
func (r *UpdateUserProfileRequest) GetAddressID() *string {
	return r.AddressID
}
