...
func NewPermissionServer(roleService services.RoleServiceInterface,
	permissionService services.PermissionServiceInterface) *PermissionServer {
...
func (s *PermissionServer) CreatePermission(ctx context.Context, req *pb.CreatePermissionRequest) (*pb.CreatePermissionResponse, error) {
	...
	if err := s.permissionService.CheckIfPermissionExists(req.Name); err != nil {
		return nil, err
	}
	...
	if err := s.permissionService.CreatePermission(&newPermission); err != nil {
	...
	permissions, err := s.permissionService.FindAllPermissions()
	if err != nil {
