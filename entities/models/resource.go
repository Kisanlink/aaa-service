...
type Resource struct {
	*base.BaseModel
	...
	Type        string  `json:"type" gorm:"size:50;not null"` // e.g., "aaa/user", "aaa/role", "aaa/permission", etc.
	Description string  `json:"description" gorm:"type:text"`
	ParentID    *string `json:"parent_id" gorm:"type:varchar(255);default:null"` // For hierarchical resources
	OwnerID     *string `json:"owner_id" gorm:"type:varchar(255);default:null"`  // Owner user ID
...
// ResourceType constants matching SpiceDB schema
const (
...
func (r *Resource) GetTableIdentifier() string {
	return "res"
}

// GetTableSize returns the table size for Resource
func (r *Resource) GetTableSize() hash.TableSize {
	return hash.Small
}
...
// GetSpiceDBObjectType returns the SpiceDB object type for this resource
func (r *Resource) GetSpiceDBObjectType() string {
	return r.Type
}

// GetSpiceDBObjectID returns the SpiceDB object ID for this resource
func (r *Resource) GetSpiceDBObjectID() string {
	return r.ID
}
