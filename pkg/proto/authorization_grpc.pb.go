...
const (
	...
	AuthorizationService_LookupResources_FullMethodName         = "/pb.AuthorizationService/LookupResources"
	AuthorizationService_CheckColumns_FullMethodName            = "/pb.AuthorizationService/CheckColumns"
	AuthorizationService_ListAllowedColumns_FullMethodName      = "/pb.AuthorizationService/ListAllowedColumns"
	AuthorizationService_EvaluatePermission_FullMethodName      = "/pb.AuthorizationService/EvaluatePermission"
	AuthorizationService_BulkEvaluatePermissions_FullMethodName = "/pb.AuthorizationService/BulkEvaluatePermissions"
)
...
func (c *authorizationServiceClient) LookupResources(ctx context.Context, in *LookupResourcesRequest, opts ...grpc.CallOption) (*LookupResourcesResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthorizationService_LookupResources_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authorizationServiceClient) CheckColumns(ctx context.Context, in *CheckColumnsRequest, opts ...grpc.CallOption) (*CheckColumnsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthorizationService_CheckColumns_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authorizationServiceClient) ListAllowedColumns(ctx context.Context, in *ListAllowedColumnsRequest, opts ...grpc.CallOption) (*ListAllowedColumnsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthorizationService_ListAllowedColumns_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authorizationServiceClient) EvaluatePermission(ctx context.Context, in *EvaluatePermissionRequest, opts ...grpc.CallOption) (*EvaluatePermissionResponse, error) {
	out := new(EvaluatePermissionResponse)
	err := c.cc.Invoke(ctx, AuthorizationService_EvaluatePermission_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authorizationServiceClient) BulkEvaluatePermissions(ctx context.Context, in *BulkEvaluatePermissionsRequest, opts ...grpc.CallOption) (*BulkEvaluatePermissionsResponse, error) {
	out := new(BulkEvaluatePermissionsResponse)
	err := c.cc.Invoke(ctx, AuthorizationService_BulkEvaluatePermissions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthorizationServiceServer) EvaluatePermission(context.Context, *EvaluatePermissionRequest) (*EvaluatePermissionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EvaluatePermission not implemented")
}
func (UnimplementedAuthorizationServiceServer) BulkEvaluatePermissions(context.Context, *BulkEvaluatePermissionsRequest) (*BulkEvaluatePermissionsResponse, error) {
...
func _AuthorizationService_EvaluatePermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EvaluatePermissionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthorizationServiceServer).EvaluatePermission(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthorizationService_EvaluatePermission_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorizationServiceServer).EvaluatePermission(ctx, req.(*EvaluatePermissionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthorizationService_BulkEvaluatePermissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BulkEvaluatePermissionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthorizationServiceServer).BulkEvaluatePermissions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthorizationService_BulkEvaluatePermissions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorizationServiceServer).BulkEvaluatePermissions(ctx, req.(*BulkEvaluatePermissionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthorizationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthorizationService_EvaluatePermission_Handler,
		},
		{
			MethodName: "BulkEvaluatePermissions",
			Handler:    _AuthorizationService_BulkEvaluatePermissions_Handler,
		},
	},
