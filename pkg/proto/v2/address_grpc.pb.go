...
const (
	...
	AddressService_GetAddressesByUser_FullMethodName = "/pb.v2.AddressService/GetAddressesByUser"
	...
	AddressService_ListAddresses_FullMethodName      = "/pb.v2.AddressService/ListAddresses"
)
...
type AddressServiceClient interface {
	...
	GetAddressesByUser(ctx context.Context, in *GetAddressesByUserRequest, opts ...grpc.CallOption) (*GetAddressesByUserResponse, error)
...
func (c *addressServiceClient) GetAddressesByUser(ctx context.Context, in *GetAddressesByUserRequest, opts ...grpc.CallOption) (*GetAddressesByUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAddressesByUserResponse)
	err := c.cc.Invoke(ctx, AddressService_GetAddressesByUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AddressServiceServer interface {
	...
	GetAddressesByUser(context.Context, *GetAddressesByUserRequest) (*GetAddressesByUserResponse, error)
...
func (UnimplementedAddressServiceServer) GetAddressesByUser(context.Context, *GetAddressesByUserRequest) (*GetAddressesByUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAddressesByUser not implemented")
}
...
func _AddressService_GetAddressesByUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAddressesByUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddressServiceServer).GetAddressesByUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AddressService_GetAddressesByUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddressServiceServer).GetAddressesByUser(ctx, req.(*GetAddressesByUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AddressService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAddressesByUser",
			Handler:    _AddressService_GetAddressesByUser_Handler,
		},
		{
	...
	Metadata: "pkg/proto/v2/address.proto",
}
