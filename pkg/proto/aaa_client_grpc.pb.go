...
func (c *aAAClientServiceClient) GetConnectionStatus(ctx context.Context, in *ClientHealthCheckRequest, opts ...grpc.CallOption) (*ClientHealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, AAAClientService_GetConnectionStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aAAClientServiceClient) RefreshSession(ctx context.Context, in *RefreshClientSessionRequest, opts ...grpc.CallOption) (*RefreshClientSessionResponse, error) {
	...
	err := c.cc.Invoke(ctx, AAAClientService_RefreshSession_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aAAClientServiceClient) GetClientMetrics(ctx context.Context, in *GetClientMetricsRequest, opts ...grpc.CallOption) (*GetClientMetricsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AAAClientService_GetClientMetrics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAAAClientServiceServer must be embedded to have forward compatible implementations.
